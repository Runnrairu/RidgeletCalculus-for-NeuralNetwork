...
ただし、<img src="https://latex.codecogs.com/gif.latex?Z:=\int_{\mathbb{Y}^{d+1}}|(\mathcal{R}_\psi&space;f)(a,b)|dadb" />は正規化定数で、その値を具体的に計算するのは困難である。そのため、Zは学習の序盤にフィッティングにより求める。
